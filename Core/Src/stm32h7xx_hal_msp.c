...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    /* ADC1 DMA Init */
  // Включаем прерывание USART1 RX/TX (приоритет ниже USB и DMA)
  ...
  else if(hadc->Instance==ADC3)
  {
    ...
    /* Peripheral clock enable. ADC3 is on AHB4 on STM32H72/H73, separate from ADC1/2. */
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    __HAL_RCC_GPIOA_CLK_ENABLE();
    /**SPI1 GPIO Configuration (MCP4261)
    PB3     ------> SPI1_SCK  (AF5)
    PB4     ------> SPI1_MISO (AF5)
    PB5     ------> SPI1_MOSI (AF5)
    PA15    ------> NSS (GPIO Output, программный)
    */
    ...
    /* PA15: NSS программный — HIGH по умолчанию (chip deselect) */
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    */
    ...
    /* SPI3 interrupt is required on STM32H7 to handle EOT after DMA transfer */
    HAL_NVIC_SetPriority(SPI3_IRQn, 12, 1);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  {
    /* USER CODE BEGIN TIM16_IC_MspInit 0 */

    /* USER CODE END TIM16_IC_MspInit 0 */
    /* Peripheral clock enable */
    __HAL_RCC_TIM16_CLK_ENABLE();
    /* TIM16 interrupt Init */
    HAL_NVIC_SetPriority(TIM16_IRQn, 6, 0);
    HAL_NVIC_EnableIRQ(TIM16_IRQn);
    /* USER CODE BEGIN TIM16_IC_MspInit 1 */

    /* USER CODE END TIM16_IC_MspInit 1 */
  }
}
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE10     ------> TIM1_CH2N
    */
    GPIO_InitStruct.Pin = OPTIC_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(OPTIC_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;  /* Open-Drain вместо Push-Pull */
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM16)
  {
    /* USER CODE BEGIN TIM16_IC_MspDeInit 0 */

    /* USER CODE END TIM16_IC_MspDeInit 0 */
    /* Peripheral clock disable */
    __HAL_RCC_TIM16_CLK_DISABLE();
    /* TIM16 interrupt DeInit */
    /* USER CODE BEGIN TIM16:TIM16_IRQn disable */
    /* HAL_NVIC_DisableIRQ(TIM16_IRQn); */
    /* USER CODE END TIM16:TIM16_IRQn disable */
    /* USER CODE BEGIN TIM16_IC_MspDeInit 1 */

    /* USER CODE END TIM16_IC_MspDeInit 1 */
  }
}
