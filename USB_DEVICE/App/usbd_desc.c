...
#define USBD_MANUFACTURER_STRING     "AM Security"
#define USBD_PID_HS     0x4001
#define USBD_PRODUCT_STRING_HS     "BMI30 TagIT"
#define USBD_CONFIGURATION_STRING_HS     "BMI30 TagIT Config"
#define USBD_INTERFACE_STRING_HS     "BMI30 TagIT CDC"
...
const char* USBD_Desc_GetConfig(void) { return USBD_CONFIGURATION_STRING_HS; }
const char* USBD_Desc_GetInterface(void) { return USBD_INTERFACE_STRING_HS; }
/* USER CODE END 1 */
/**
  * @}
  */
